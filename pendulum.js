...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function Fa(){return new vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:$s(),fragmentShader:`
		...
		`,blending:mn,depthTest:!1,depthWrite:!1})}function Oa(){return new vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$s(),fragmentShader:`
...
`].filter(gi).join(`
`)),a=Is(a),a=Ka(a,t),a=Za(a,t),o=Is(o),o=Ka(o,t),o=Za(o,t),a=$a(a),o=$a(o),t.isRawShaderMaterial!==!0&&(b=`#version 300 es
